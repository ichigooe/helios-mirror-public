...
async def homepage(request):
    ...
    return web.Response(text="<h1>See mirror-leech-telegram-bot <a href='https://t.me/jkxmirror'>@GitHub</a> By <a href='https://t.me/jkxmirror'>Anas</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>JKxbots</h3>", content_type="text/html")
            return response
